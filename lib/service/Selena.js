...
import { StatusTest } from "./Test.js";
...
var TypeOfRunByCategory;
(function (TypeOfRunByCategory) {
    TypeOfRunByCategory["allTests"] = "All tests";
    TypeOfRunByCategory["specificTest"] = "Specific test";
})(TypeOfRunByCategory || (TypeOfRunByCategory = {}));
var Selena = /** @class */ (function () {
    ...
    Selena.prototype.run = function () {
        ...
        Log.warning("".concat(this.categories.length, " categories were found"));
    ...
    Selena.prototype.runByCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var category, categoryIndex, typeOfRunByCategory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        typeOfRunByCategory = (_a.sent()).typeOfRunByCategory;
                        if (!(typeOfRunByCategory == TypeOfRunByCategory.specificTest)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.runSpecificTestFromCategory(categoryIndex)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                    case 4:
    ...
    Selena.prototype.runSpecificTestFromCategory = function (categoryIndex) {
        return __awaiter(this, void 0, void 0, function () {
            var test, testIndex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prompt({
                            ...
                            choices: this.categories[categoryIndex].tests.map(function (c) { return c.getName(); })
                        })];
                    case 1:
                        test = (_a.sent()).test;
                        testIndex = this.categories[categoryIndex].tests.findIndex(function (c) { return c.getName() == test; });
                        return [4 /*yield*/, this.categories[categoryIndex].tests[testIndex].runTest()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
