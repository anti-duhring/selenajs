...
var Test = /** @class */ (function () {
    function Test(props) {
        ...
        this.log = {
            name: props.name,
            category: (_d = props.category) !== null && _d !== void 0 ? _d : this.name,
            message: null,
            status: "progress"
        };
    }
    ...
    Test.prototype.runTest = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.testFunction) return [3 /*break*/, 6];
                        Log.warning("Loading test \"".concat(this.name, "\"..."));
                        return [4 /*yield*/, this.builder.build()];
                    case 1:
                        driver = _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    Test.prototype.passed = function () {
        var log = __assign(__assign({}, this.getLog()), { status: 'passed' });
        this.log = log;
        Log.success("Test \"".concat(this.name, "\" has passed!"));
    };
    Test.prototype.failed = function (message) {
        var log = __assign(__assign({}, this.getLog()), { status: 'failed', message: message });
        this.log = log;
        throw new Error("Test \"".concat(this.name, "\" failed. \nReason: ").concat(message));
    };
