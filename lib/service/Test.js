...
(function (StatusTest) {
    StatusTest[StatusTest["passed"] = 0] = "passed";
    StatusTest[StatusTest["failed"] = 1] = "failed";
    StatusTest[StatusTest["progress"] = 2] = "progress";
...
var Test = /** @class */ (function () {
    ...
    Test.prototype.failed = function (message) {
        if (this.log.status == StatusTest.passed)
            return;
